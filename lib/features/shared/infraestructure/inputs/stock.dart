...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.value) return 'El stock debe ser mayor o igual que cero';
    if (displayError == StockError.format) return 'El stock no tiene un formato valido';
  ...
  StockError? validator(int value) {
    ...
    if(int.tryParse(value.toString()) == null) return StockError.format;
